/*!
* Parsley.js
* Version 2.3.5 - built Thu, Mar 17th 2016, 6:13 pm
* http://parsleyjs.org
...
(function (global, factory) {
  ...
  var ParsleyDefaults = {
    ...
    errorsContainer: function errorsContainer(ParsleyField) {
      var container = $(ParsleyField.$element).parents('.form-group').find('.errors-container');
      return container;
    },

    // ul elem that would receive errors' list
    errorsWrapper: '<ul class="list-unstyled parsley-errors-list"></ul>',
