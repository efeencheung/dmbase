...
class Role
{
     ...
     * Add accessControls
     *
     * @param \Dm\Bundle\SecurityBundle\Entity\AccessControl $accessControls
     * @return Role
     */
    public function addAccessControl(\Dm\Bundle\SecurityBundle\Entity\AccessControl $accessControls)
    {
     ...
     * @param \Dm\Bundle\SecurityBundle\Entity\AccessControl $accessControls
     */
    public function removeAccessControl(\Dm\Bundle\SecurityBundle\Entity\AccessControl $accessControls)
    {
        $this->accessControls->removeElement($accessControls);
    }
